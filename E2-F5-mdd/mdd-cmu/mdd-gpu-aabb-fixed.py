...
### non-batch version
def get_avg_posterior(model, text_in, cond, pid_seq, cfg_strength_gop=0, diff_symbol=None, masking_ratio=1, sway_sampling_coef=-1, steps=32, t_interval=16):
    ...
    for i in range(iter_num):
        ...
        log_prob_y0_temp, log_prob_y0_null_temp = model.compute_prob_aabb_fixed( **input_kwargs)
