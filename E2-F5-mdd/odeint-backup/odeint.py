...
from .fixed_grid import Euler, Euler_MDD, Euler_MDD_Wrong, Midpoint, Heun2, Heun3, RK4
...
def odeint_jacobian(func, y0, t, cond_mask, t_inerval, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None):
    """Integrate a system of ordinary differential equations.
    ...
    if event_fn is None:
        solution, jacob_trace = solver.integrate(t, cond_mask, t_inerval)
    else:
...
##XINWEI: return jacobian and the trajectory
def odeint_jacobian_wrong(func, y0, t, cond_mask, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None):
    """Integrate a system of ordinary differential equations.
