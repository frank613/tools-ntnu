...
if __name__ == "__main__":
    ...
    for p in p_set:
        ...
        #feats = [[feat[0]] + feat[1::2] for feat in feats]
    ...
    for p in p_set:
        ...
        #feats_eva = feats_eva[:,1:]
        #feats_eva = feats_eva[:,1::2]
        #feats_1 = feats_eva[:,0].reshape(feats_eva.shape[0],-1)
        #feats_eva = np.concatenate((feats_1,feats_eva),axis=1)
