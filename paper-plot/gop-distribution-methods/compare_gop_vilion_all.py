...
def plot(df, data_labels):
    ...
    #ax.set_title('Gop distribution using different methods for CMU-kids')
    ax.get_yaxis().set_visible(False)
    ax.set_xlim([-20, 0.1])
    plot_labels.reverse()
    ax.legend(*zip(*plot_labels), loc=2)
    outFile = "./out-compare-dnn-vilion/all-cmui.png"
...
if __name__ == "__main__":
    ...
    plot(df, ['gmm-mono-align', 'gmm-mono-frame', 'gmm-tri-frame','dnn-mono-frame', 'dnn-tri-frame'])
