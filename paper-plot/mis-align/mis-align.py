...
def plot_it(out_file):
    ...
    fig, axes = plt.subplots(2,3,figsize=(90, 30), sharex="col", sharey="row", layout="constrained", width_ratios=[1,5,5], height_ratios=[1,2.5])
    ...
    #    bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 10}, horizontalalignment="right", verticalalignment="center", weight='bold')
    axes[0][0].text(0,0.5, 'model\'s activations', style='italic', color="tab:blue", horizontalalignment="right", verticalalignment="center", weight='bold')
    ...
    axes[1][1].plot((0, p1_l), (pos_g,pos_g), '-', color="gray",  linewidth=5.0)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_g,pos_g), '|', color="gray", markersize=100)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_g,pos_g), '-', color="gray", linewidth=5.0)

    pos_g_text = pos_g + 0.5
    ...
    axes[1][2].plot((0, a1-1), (pos_g,pos_g), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a1+1, a2-1), (pos_g,pos_g), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a2+1, a3-1), (pos_g,pos_g), '-', color="gray", linewidth=5.0)
    ...
    #axes[1][0].text(0, pos_g, 'ground truth align', style='italic', color="tab:blue",
    #    bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 10}, horizontalalignment="right", verticalalignment="center")
    axes[1][0].text(0, pos_g, 'ground truth align', style='italic', color="tab:blue", horizontalalignment="right", verticalalignment="center", weight='bold')
    #plot substituion
    pos_s = pos_g - 2
    #axes[1][0].text(0, pos_s, 'simulated SUB L->M', style='italic', color="tab:blue",
    #    bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 10}, horizontalalignment="right", verticalalignment="center")
    axes[1][0].text(0, pos_s, 'simulated SUB L->M', style='italic', color="tab:blue", horizontalalignment="right", verticalalignment="center", weight='bold')
    ...
    axes[1][1].plot((0, p1_l), (pos_s,pos_s), '-', color="gray",  linewidth=5.0)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_s,pos_s), '|', color="gray", markersize=100)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_s,pos_s), '-', color="gray", linewidth=5.0)

    pos_s_text = pos_s + 0.5
    ...
    axes[1][2].plot((0, a1-1), (pos_s,pos_s), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a1+1, a2-1), (pos_s,pos_s), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a2+1, a3-1), (pos_s,pos_s), '-', color="gray", linewidth=5.0)
    ...
    #plot insertion
    pos_d = pos_g - 4
    #axes[1][0].text(0, pos_d, 'simulated INS of SH', style='italic', color="tab:blue",
    #    bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 10}, horizontalalignment="right", verticalalignment="center", weight='bold')
    axes[1][0].text(0, pos_d, 'simulated INS of SH', style='italic', color="tab:blue", horizontalalignment="right", verticalalignment="center", weight='bold')
    ...
    axes[1][1].plot((0, p1_l), (pos_d,pos_d), '-', color="gray",  linewidth=5.0)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_d,pos_d), '|', color="gray", markersize=100)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_d,pos_d), '-', color="gray", linewidth=5.0)

    pos_d_text = pos_d + 0.5
    ...
    axes[1][2].plot((0, a2-1), (pos_d,pos_d), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a2+1, a3-1), (pos_d,pos_d), '-', color="gray", linewidth=5.0)
    ...
    #plot deletion
    pos_i = pos_g - 6
    #axes[1][0].text(0, pos_i, 'simulated DEL of S', style='italic', color="tab:blue",
    #    bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 10}, horizontalalignment="right", verticalalignment="center", weight='bold')
    axes[1][0].text(0, pos_i, 'simulated DEL of S', style='italic', color="tab:blue", horizontalalignment="right", verticalalignment="center", weight='bold')
    ...
    axes[1][1].plot((0, p1_l), (pos_i,pos_i), '-', color="gray",  linewidth=5.0)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_i,pos_i), '|', color="gray", markersize=100)
    axes[1][1].plot((p3_r+1, array_len-1), (pos_i,pos_i), '-', color="gray", linewidth=5.0)

    pos_i_text = pos_i + 0.5
    ...
    axes[1][2].plot((0, a1-1), (pos_i,pos_i), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a1+3, a2-1), (pos_i,pos_i), '-', color="gray", linewidth=5.0)
    axes[1][2].plot((a2+1, a3-1), (pos_i,pos_i), '-', color="gray", linewidth=5.0)
    ...
    axes[1][2].text(a1+2, pos_i_text, 'S', color='cyan')
