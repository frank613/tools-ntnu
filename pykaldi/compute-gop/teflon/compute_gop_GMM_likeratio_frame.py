...
if __name__ == "__main__":
    ...
    # Define feature pipeline as a Kaldi rspecifier (splice-opts must be get from the model folder)
    feats_rspecifier = ( 
            "ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:{0}/utt2spk scp:{0}/cmvn.scp scp:{0}/feats.scp ark:- | splice-feats --left-context=3 --right-context=3 ark:- ark:- | transform-feats {1}/final.mat ark:- ark:- |").format(sys.argv[4], sys.argv[2])
