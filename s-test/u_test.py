...
def ranksum_test(gop_df1, gop_df2,  symbol):
    stat, p = mannwhitneyu(gop_df1.loc[gop_df1["symbol"]== symbol, 'GOP-score'], gop_df2.loc[gop_df2["symbol"]== symbol, 'GOP-score'])
...
if __name__ == "__main__":
    ...
    ranksum_test(gop_df1, gop_df2, sys.argv[3])
