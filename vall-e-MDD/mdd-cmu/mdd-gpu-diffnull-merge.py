...
### non-batch version
def get_avg_posterior(model, text_in, prop_in, resp_in, lang, pid_seq, cmp_len=False, is_ar_level_0 = False, masking_nar_level_0 = True, cfg_strength_lv0=0, diff_symbol="null", mask_ratio_lv0=1.2, total_levels=8):
