...
def load_dataset_local_from_dict(csv_path, cache_additional, trans_map, uttid_list, lang_code, subset=None):
...
if __name__ == "__main__":
    ...
    ds= load_dataset_local_from_dict(csv_path, "cmu-kids", trans_map, uttid_list, lang_code="en-us", subset=subset_list)
    ...
    ds.map(batch_process, fn_kwargs={"p_tokenizer":p_tokenizer, "device":device, "out_path":out_path}, batched=True, batch_size=1, num_proc=10)
