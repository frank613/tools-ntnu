...
def get_text(text_in, device, phn_symmap):
    ...
    phns = encode_text( text, phn_symmap, language=lang)
...
if __name__ == "__main__":
    ...
    print(sys.argv)
    if len(sys.argv) != 7:
        sys.exit("this script takes 6 arguments <model-ckpt-sft> <in-audio-wav-file> <in-raw-text-file> <CTM-alignment-file> <gop-tokenizer-path> <out-gop-path> \n \
    ...
    phns,lang = get_text(text_in, device, phn_symmap)
    ##prompt
