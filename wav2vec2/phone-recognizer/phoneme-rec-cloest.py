...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        for row in dataset:
            ...
            sim_mat, idx2 = sim_mat.max(-1) # sim_mat = (seq_len, 320) idx = (seq_len,320)
            idx1 = sim_mat.argmax(-1) # shape = (seq_len)
            idx2 = idx2[torch.arange(idx1.shape[0]), idx1]
            idx = torch.stack((idx1, idx2), dim=0)#shape = (2, N_frames,)
