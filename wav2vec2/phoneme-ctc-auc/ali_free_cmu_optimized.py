...
def compute_denom_log(post_mat, labels, alphas, betas, order):
        ...
        for row in ds:
            ...
            for order, pid in enumerate(labels):
                if pid in pid_set:
                    ...
                    denom_log = compute_denom_log(post_mat, batch_label[0], alphas[0], betas[0], order)
                    gop_scores = -ll_self - denom_log
