...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='it analyzes the AUC using replacement error, the csv path must be a folder containing audios files and the csv')
