...
from my_w2v2_package.custom_CTC_module import Wav2Vec2ForRSILNOJCTC
...
if __name__ == "__main__":
    ...
    model = Wav2Vec2ForRSILNOJCTC.from_pretrained(
        model_path, 
        #ctc_loss_reduction="mean", 
        pad_token_id=processor.tokenizer.pad_token_id,
        sil_token = len(vocab_dict)-1,
        vocab_size=len(vocab_dict),
        ignore_mismatched_sizes=True ##must have it because now we are training the LM with the additional SIL
    )
